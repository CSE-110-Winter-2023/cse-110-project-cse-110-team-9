...
public class CompassView extends View {
    ...
    public void setDegrees(float degrees, boolean animation) {
        ...
        if (animation) {
            ...
            if (Math.abs(mTargetDegrees - mDegrees) <= 15 || Math.abs(mTargetDegrees - mDegrees) >= 345)
                mTimerPeriod = 30;
            else if (Math.abs(mTargetDegrees - mDegrees) <= 30 || Math.abs(mTargetDegrees - mDegrees) >= 330)
                mTimerPeriod = 20;
            else if (Math.abs(mTargetDegrees - mDegrees) <= 60 || Math.abs(mTargetDegrees - mDegrees) >= 300)
                mTimerPeriod = 10;
            else mTimerPeriod = 5;
